...
# Manuscript Alert System Installer
# This script installs the manuscript alert system as a local web app

set -e

echo "=== Manuscript Alert System Installer ==="
echo ""
...
chmod +x "$SCRIPT_DIR/run_alert_app.sh"
...
Exec=$SCRIPT_DIR/run_alert_app.sh
Type=Application
Terminal=true
...
echo "2. Run: $SCRIPT_DIR/run_alert_app.sh"
